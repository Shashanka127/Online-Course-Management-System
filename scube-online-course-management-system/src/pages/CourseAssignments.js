          ...
          <>
              ...
              <div className="flex items-center justify-between h-16">
                <div className="flex items-center">
                  ...
                  <div className="hidden md:block">
                    ...
                    <Link to='/courseAssignments' className="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">
                      Assignments
                    </Link>
                    <Link to='/courseForum' className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                      Course Forum
                    </Link>
                    </div>
                  </div>
            ...
            <Disclosure.Panel className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <Link to='/createdcourseAssignmentsCourses' className="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium">
                  Course Assignments
                </Link>
                <Link to='/courseForum' className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
                  Course Forum
                </Link>
              </div>
