          ...
          <>
              ...
              <div className="flex items-center justify-between h-16">
                <div className="flex items-center">
                  ...
                  <div className="hidden md:block">
                    ...
                    <Link to='/professorhome' className="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">
                      Your Profile
                    </Link>
            ...
            <Disclosure.Panel className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <Link to='/professorhome' className="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium">
                  Your Profile
                </Link>
