          ...
          <main className="mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-5xl tracking-tight font-extrabold text-indigo-900 sm:text-5xl md:text-6xl">
                ...
                <span className="block text-blue-600 xl:inline">Online Course<br/>Management<br/>System</span>
              </h1>
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                ...
                <Link
                  to="/register"
                  className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-300 hover:bg-indigo-500 md:py-4 md:text-lg md:px-10"
                >
                  Register
                </Link>
                </div>
